...
class Endpoints{
  ...
  static const String addDonation = "http://${Constants.djangoHost}/Endpoints/add_donation/";
  static const String getDonations = "http://${Constants.djangoHost}/Endpoints/get_donations/";
  static const String takeDonation = "http://${Constants.djangoHost}/Endpoints/take_donation/";
  static const String updatePassword = "http://${Constants.djangoHost}/Endpoints/create_new_password/";
}
