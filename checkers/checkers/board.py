import pygame
from .constants import WHITE, ROWS, BROWN, SQUARE_SIZE, COLS, BEIGE
...
class Board:
    def __init__(self):
        self.board = []
        self.brown_left = self.beige_left = 12
        self.brown_kings = self.beige_kings = 0
        self.create_board()
    ...
    def evaluate(self):
        return (
            self.beige_left
            - self.brown_left
            + (self.beige_kings * 0.5 - self.brown_kings * 0.5)
        )
