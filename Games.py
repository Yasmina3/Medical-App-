...
def run_logic(window, pageTitle):
    button1 = tk.Button(
        ...
        command=lambda: open_window(
            "Connect Four", "start connect 4", "#0E153A", window
        ),
    )
    ...
    button3 = tk.Button(
        ...
        bg="#1CFFD0",
        command=lambda: open_window(
            "Tic Tac Toe", "start Tic Tac Toe", "#0E153A", window
        ),
    )
    ...
    button4 = tk.Button(
        ...
        height=2,
        bg="#1CFFD0",
        command=lambda: open_window("Checkers", "start Checkers", "#0E153A", window),
    )
    button4.place(x=320, y=350)
